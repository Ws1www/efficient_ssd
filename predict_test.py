...
def main(args):
    ...
    num_classes = 20 + 1 # 三类物体，一类背景
    model = create_model(num_classes)

    weights_path = r'ssd300-46.pth'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='yg/Imgs-trainval/JPEGImages-trainval/00022.jpg', help='dataset')
